...
The refund will go directly to you, so you may choose "individual or sole proprietorship"
![](files/tax_info.png)
...
::: {.column width="40%"}
::: {.callout-note}
The bank address does not have to be from the branch where you originally opened your account.  
For example, if your bank account is with **Chase**, you may enter the address of **any Chase branch that is close to you**. Alternatively, you may use the bank address listed on your bank statement.
:::
:::
